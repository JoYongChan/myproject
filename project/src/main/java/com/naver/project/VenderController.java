...
public class VenderController {
	...
	public String venderproductList(Model model) {
		...
		for(int i = 0; i < venderproducts.size(); i++) {
			...
			venderproducts.get(i).setProname(prodao.selectOneUsingProcode(venderproducts.get(i).getProcode()).getProname());
			venderproducts.get(i).setCapacity(prodao.selectOneUsingProcode(venderproducts.get(i).getProcode()).getCapacity());
		}
